...
#SBATCH --output=/users/ssilje/CMOR/logs/cmorlight/master_py_%j.out
#SBATCH --error=/users/ssilje/CMOR/logs/cmorlight/master_py_%j.err
#SBATCH --job-name="master_py"

script_folder="/users/${USER}/CMOR/CCLM2CMOR/src/CMORlight"
